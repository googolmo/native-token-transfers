...
#[derive(Debug, Clone, ShankContext)]
#[rustfmt::skip]
pub enum Instruction {
  #[account(0, writable, signer, name = "payer", desc="payer")]
  #[account(1, signer, name = "deployer", desc="deployer")]
  #[account(2, name = "program_data", desc="program_data")]
  #[account(3, writable, name = "config", desc="config")]
  #[account(4, name = "mint", desc="mint")]
  #[account(5, writable, name = "rate_limit", desc="rate_limit")]
  #[account(6, name = "token_authority", desc="token_authority")]
  #[account(7, name = "multisig_token_authority", desc="multisig_token_authority")]
  #[account(8, writable, name = "custody", desc="custody")]
  #[account(9, name = "token_program", desc="token_program")]
  #[account(10, name = "associated_token_program", desc="associated_token_program")]
  #[account(11, name = "bpf_loader_upgradeable_program", desc="bpf_loader_upgradeable_program")]
  #[account(12, name = "system_program", desc="system_program")]
