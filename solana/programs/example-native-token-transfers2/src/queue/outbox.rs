...
use ntt_messages2::{chain_id::ChainId, trimmed_amount::TrimmedAmount};
use shank_macro::ShankAccount;
use solana_pubkey::Pubkey;
use crate::{bitmap::*, clock::current_timestamp, error::NTTError, result::Result};
use super::rate_limit::RateLimitState;

#[derive(ShankAccount, Debug, PartialEq, Eq, BorshDeserialize, BorshSerialize)]
...
#[derive(ShankAccount, PartialEq, Eq, Debug, BorshDeserialize, BorshSerialize)]
