...
#[cfg(feature = "borsh")]
impl<E: Transceiver, A: TypePrefixedPayload> BorshDeserialize for TransceiverMessage<E, A>
where
    A: MaybeSpace,
{
...
#[cfg(feature = "borsh")]
impl<E: Transceiver, A: TypePrefixedPayload> BorshSerialize for TransceiverMessage<E, A>
where
    A: MaybeSpace,
{
