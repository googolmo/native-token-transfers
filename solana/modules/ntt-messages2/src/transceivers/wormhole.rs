...
#[cfg(feature = "borsh")]
impl borsh::BorshDeserialize for WormholeTransceiverInfo {
...
#[cfg(feature = "borsh")]
impl borsh::BorshSerialize for WormholeTransceiverInfo {
...
#[cfg(feature = "borsh")]
impl borsh::BorshDeserialize for WormholeTransceiverRegistration {
    fn deserialize_reader<R: std::io::Read>(reader: &mut R) -> std::io::Result<Self> {
        Readable::read(reader)
    }
}
...
#[cfg(feature = "borsh")]
impl borsh::BorshSerialize for WormholeTransceiverRegistration {
    fn serialize<W: std::io::Write>(&self, writer: &mut W) -> std::io::Result<()> {
        Writeable::write(self, writer)
    }
}
